...
public class WebDriverUtility {
	...
	/**
	 * This method will use for scrollIntoView method to select web element.
	 * 
	 * @param d
	 * @param value
	 * @param Element
	 */
	public void scrollIntoView(WebDriver d, boolean value, WebElement Element) {
		JavascriptExecutor js = (JavascriptExecutor) d;
		js.executeScript("arguments[0].scrollIntoView(" + value + ")", Element);
	}

	/**
	 * This method will send the value using javascript executor
	 * 
	 * @param d
	 * @param value
	 * @param Element
	 */
	public void sendValueAsJSExecutor(WebDriver d, String value, WebElement Element) {
		JavascriptExecutor js = (JavascriptExecutor) d;
